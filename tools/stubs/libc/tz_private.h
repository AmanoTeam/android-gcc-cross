...
/* Hide the public <time.h> declarations of symbols this file redefines
   statically, so they don't conflict with our static definitions. */
#define tzname sys_tzname
#define daylight sys_daylight
...
#define timegm sys_timegm
#define timelocal sys_timelocal
#include <time.h>
#undef localtime_rz
#undef mktime_z
#undef posix2time_z
...
static time_t timegm(struct tm *);
#endif
...
static struct tm *offtime(time_t const *, long);
# endif
# if TZ_TIME_T || !defined timelocal
static time_t timelocal(struct tm *);
# endif
# if TZ_TIME_T || !defined timeoff
static time_t timeoff(struct tm *, long);
# endif
# if TZ_TIME_T || !defined time2posix
static time_t time2posix(time_t);
# endif
# if TZ_TIME_T || !defined posix2time
static time_t posix2time(time_t);
# endif
#endif
...
ATTRIBUTE_REPRODUCIBLE static time_t posix2time_z(timezone_t, time_t);
#  endif
#  if TZ_TIME_T || !defined time2posix_z
ATTRIBUTE_REPRODUCIBLE static time_t time2posix_z(timezone_t, time_t);
#  endif
# endif
#endif
