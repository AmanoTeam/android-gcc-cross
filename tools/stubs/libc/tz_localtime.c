...
/* Android libc build flags (see libc/Android.bp libc_tzcode cflags), plus our
   additions: all public symbols except tzalloc/tzfree/localtime_rz/mktime_z are
   static because the dynamic libc already provides them. */
#define ALL_STATE 1
#define STD_INSPIRED 1
#define THREAD_SAFE 1
#define TM_GMTOFF tm_gmtoff
#define TZDEFAULT NULL
#define TZDIR "/system/usr/share/zoneinfo"
...
static NETBSD_INSPIRED_EXTERN time_t
